...
const Page = () => {
    ...
    const biometricAuthPress = async () => {
    ...
    return (
        <SafeAreaView>
            <Text style={styles.greetings}>Welcome back, {firstName}</Text>
            ...
            <View style={styles.numbersView}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <TouchableOpacity onPress={biometricAuthPress}>
