...
import { Currency } from '@/app/api/interfaces/crypto'
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', gap: 14, alignItems: 'center' }}>
                                ...
                                <View style={{ gap: 6, alignItems: 'flex-end' }}>
                                    ...
                                    <View style={{ flexDirection: 'row', gap: 4 }}>
                                        <Ionicons name={currency.quote.EUR.percent_change_1h > 0 ? 'arrow-up' : 'arrow-down'} size={16} color={currency.quote.EUR.percent_change_1h > 0 ? 'green' : 'red'} />
